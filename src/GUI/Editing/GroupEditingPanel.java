...
public class GroupEditingPanel extends JPanel {
    ...
    JLabel backgroundHeader = new JLabel(new ImageIcon("images/TgrouptEditingHeader.jpg"));
    JLabel findeBTN = new JLabel(new ImageIcon("images/findVerticalButton.jpg"));
